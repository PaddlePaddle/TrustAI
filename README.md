...
<p align="center">
<img align="center" src="./imgs/sentiment_labeled_case.png", width=650><br>
图3 情感分析标注数据
</p>
<br>

<p align="center">
<img align="center" src="./imgs/pretrained_labeled_case.png", width=650 ><br>
图4 预训练模型标注数据
</p>
...
本工具基于可信分析结果对数据和模型缺陷进行分析，继而给出模型增强方案。我们提供一些基于证据分析发现模型缺陷的方法，供大家参考。
- 基于稀疏数据识别及丰富的增强方案：提供“稀疏数据识别->有效数据选择->训练数据丰富”流程，帮助开发者更小成本完成数据标注。
- 基于脏数据识别及清洗的增强方案：通过分析数据对模型的影响，从训练集中挑选候选脏数据清洗，提升模型效果。
- 基于数据分布偏置识别及均衡方案：根据证据分布分析模型的偏置缺陷，通过训练数据分布修正和权重修正来缓解偏置问题。
- 基于先验知识的模型增强：根据已有的先验知识指导模型学习，提升模型效果和可解释性。
...
<p align="center">
<img align="center" src="./imgs/example_case.png", width=300><br>
图7 可信分析实例
</p>
